...
def visualize_modules(low_R, low_L, gamma_R, gamma_L, enhance_L, x_gamma, enhance_img, x_low, x_normal, filename,
    ...
    try:
        ...
        axes[5].set_title("Gamma Image", fontsize=9)
        axes[5].axis("off")
...
def train(args, model, train_loader, test_loader, optimizer, scheduler, device, resume_epoch=0):
    ...
    for epoch in range(resume_epoch, args.epochs):
        ...
        for batch_idx, (name, x_low, x_normal) in enumerate(train_loader):
            ...
            # 前向传播
            low_R, low_L, gamma_R, gamma_L, enhance_L1, enhance_L, x_gamma, enhance_img = model(x_low)
